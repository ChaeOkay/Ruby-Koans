...
class AboutRegularExpressions < EdgeCase::Koan
  ...
  def test_asterisk_means_zero_or_more
    ...
    # A. when a target isn't specified
  end
  ...
  #
  # Why?
  # A. The example below demonstrates that the asterisk is 
  # looking for "zero or more" instances of anything within the / /, it's not
  # matching any sort of string, it's looking at items indepedantly.
